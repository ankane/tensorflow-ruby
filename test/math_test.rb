...
class MathTest < Minitest::Test
  def test_abs
    assert_equal 1, Tf.abs(Tf::Tensor.constant(-1)).value
    assert_equal 1, Tf::Math.abs(Tf::Tensor.constant(-1)).value
  end

  def test_add
    a = Tf::Tensor.constant(2)
    b = Tf::Tensor.constant(3)
  ...
  def test_divide
    a = Tf::Tensor.constant(3.0)
    b = Tf::Tensor.constant(2.0)
  ...
  def test_reduce_any
    x = Tf::Tensor.constant([[true, true], [false, false]])
  ...
  def test_reduce_std
    x = Tf::Tensor.constant([[1.0, 2.0], [3.0, 4.0]])
  ...
  def test_reduce_sum
    x = Tf::Tensor.constant([[1, 1, 1], [1, 1, 1]])
